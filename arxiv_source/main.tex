...
\begin{figure}[!t]
\centering
\makebox[\linewidth][c]{\includegraphics[width=0.98\linewidth]{figures/fig_method_coupled_auc.pdf}}
...
\begin{figure}[!t]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.20\linewidth]{figures/generated/figure7_relation_frame_shape_path.png}}
...
\begin{figure}[!t]
\centering
\makebox[\linewidth][c]{\includegraphics[width=0.92\linewidth]{figures/fig_endpoint_frontier.pdf}}
...
\begin{figure}[!t]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth]{figures/fig_paths_70B.pdf}}
